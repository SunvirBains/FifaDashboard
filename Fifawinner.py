...
app.layout = html.Div(style=container_style, children=[
    ...
    html.Div(style=navbar_style, children=[
        html.Div([
            ...
            dcc.Dropdown(
                id='Country_dropdown',
                options=[{'label': html.Span(country, style={'color': 'black'}), 'value': country}
                         for country in wins['Country']],
                value=None,
                placeholder="Country",
        ...
        html.Div([
            ...
            dcc.Dropdown(
                id='Year_dropdown',
                options=[{'label': html.Span(str(year), style={'color': 'black'}), 'value': year}
